package com.bank.bian.customereventhistory.model;
...
/**
 * The BIAN control record for this service domain: "Customer Event Log Maintenance Agreement".
 *
 ...
 * to its asset type (Customer Event Log). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Customer Event Log Maintenance Agreement";
